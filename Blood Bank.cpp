                ...
                if(choice == 'y' || choice =='Y' ) {
                   ifstream jin("Blood Bank");
                    ...
                    for(int i =0; i< 8; i++) {
                        ...
                        for(int i=0; i<1; i++) {
                            cout<<"\nA Positive Blood Bottles in stock "<<bloodGroups[0]<<endl;
                            cout<<"A Negative Blood Bottles in stock "<<bloodGroups[1]<<endl;
                            cout<<"B Positive Blood Bottles in stock "<<bloodGroups[2]<<endl;
                            cout<<"B Negative Blood Bottles in stock "<<bloodGroups[3]<<endl;
                            cout<<"O Positive Blood Bottles in stock "<<bloodGroups[4]<<endl;
                            cout<<"O Negative Blood Bottles in stock "<<bloodGroups[5]<<endl;
                            cout<<"AB Positive Blood Bottles in stock "<<bloodGroups[6]<<endl;
                            cout<<"AB Negative Blood Bottles in stock "<<bloodGroups[7]<<endl;
                        }
                    }
